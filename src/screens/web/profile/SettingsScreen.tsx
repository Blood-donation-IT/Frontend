...
const SettingsScreen = ({ navigation }) => {
  ...
  const dividerColor = isLight ? "#e8e8e8" : "#2a2a2a";
        ...
        <View style={styles.section}>
          ...
          <View style={[styles.blockContainer, { backgroundColor: blockBackgroundColor }]}>
            <TouchableOpacity style={styles.option}>
              ...
              <Ionicons name="chevron-forward" size={18} color={isLight ? "#aaaaaa" : "#555555"} />
            </TouchableOpacity>
          </View>
        </View>
          ...
          <View style={styles.modalOverlay}>
            <View style={styles.modalContainer}>
              <Text style={styles.modalTitle}>
                {alertType === 'confirm_logout' && t('logout_dialog_title')}
              </Text>
              <Text style={styles.modalMessage}>
                {alertType === 'confirm_logout' && t('logout_dialog_message')}
              </Text>
...
const styles = StyleSheet.create({
  modalOverlay: {
    ...
    alignItems: 'center',
    ...Platform.select({
      web: { alignSelf: 'center', width: '100%', maxWidth: 440 },
    }),
  },
  modalContainer: {
    width: '90%',
