...
const styles = StyleSheet.create({
  ...
  title: { fontFamily: 'Inter', fontWeight: '700', fontSize: 22 },
  icon: { marginLeft: 10 },
  waveTop: { width: 440, height: 278, alignSelf: 'center', position: 'absolute', bottom: 0 },
  waveMid: { width: 437, height: 216, alignSelf: 'center', position: 'absolute', bottom: 0 },
  waveBot: { width: 436, height: 198, alignSelf: 'center', position: 'absolute', bottom: 0 },
});
