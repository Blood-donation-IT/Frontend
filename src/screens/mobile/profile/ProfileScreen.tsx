...
const ProfileScreen = ({ navigation }) => {
  ...
  const mockDonations = [
    { id: 1, type: "Whole blood", date: "August 25, 2025", hospital: "Saint Panteleimon Hospital", status: "Canceled", amount: "450 ml" },
    { id: 2, type: "Whole blood", date: "August 25, 2025", hospital: "Saint Panteleimon Hospital", status: "Successfully", amount: "450 ml" },
    { id: 3, type: "Whole blood", date: "August 25, 2025", hospital: "Saint Panteleimon Hospital", status: "Successfully", amount: "450 ml" },
    { id: 4, type: "Whole blood", date: "August 25, 2025", hospital: "Saint Panteleimon Hospital", status: "Successfully", amount: "450 ml" }
  ];
      ...
      <View style={styles.contentContainer}>
        ...
        <View style={styles.statsRow}>
          <View style={[styles.statBox, { borderColor: "#FFD1D1" }]}>
             ...
             {/* <Text style={styles.statValue}>{user?.donations_count < 10 && user?.donations_count > 0 ? `0${user?.donations_count}` : user?.donations_count || "00"}</Text> */}
          </View>
          <View style={[styles.statBox, { borderColor: "#FFD1D1" }]}>
             <Text style={styles.statLabel}>{t("blood_type") || "Blood Type"}</Text>
             <Text style={styles.statValue}>A+</Text>
             {/* <Text style={styles.statValue}>{user?.blood_type || "N/A"}</Text> */}
          </View>
          <View style={[styles.statBox, { borderColor: "#FFD1D1" }]}>
             <Text style={styles.statLabel}>{t("life_saved") || "Life Saved"}</Text>
             <Text style={styles.statValue}>02</Text>
             {/* <Text style={styles.statValue}>{user?.lives_saved_count < 10 && user?.lives_saved_count > 0 ? `0${user?.lives_saved_count}` : user?.lives_saved_count || "00"}</Text> */}
          </View>
        </View>
