    ...
    <View style={[styles.mainContainer, { backgroundColor: "#f9f9f9ff" }]}>
      ...
      >
        ...
        <View style={[styles.redCard, { backgroundColor: colors.primary || "#F86E6E" }]}>
          ...
          <Text style={styles.cardTitle}>{donationData.type || "Whole Blood"}</Text>
          <Text style={styles.cardSubtitle}>
            {donationData.date || "August 25, 2025"} • 08:30
          </Text>

          
          <View style={styles.pillsRow}>
            <View style={styles.pill}>
              <Text style={styles.pillText}>{donationData.amount || "450"}</Text>
        ...
        <View style={styles.detailsContainer}>
          <DetailRow 
            ...
            value={`${donationData.date || "Aug 25, 2025"}\n08:30`} 
          />
          <DetailRow 
            label={t("place") || "Place"} 
            value={donationData.hospital || "Saint Panteleimon Hospital"} 
          />
          <DetailRow 
          ...
          <DetailRow 
            ...
            value={`${donationData.amount || "450"} ${donationData.unit || "ml"}`} 
          />
          <DetailRow 
