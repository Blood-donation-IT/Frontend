  ...
  const mockHistoryData = [
    {
      year: "2025",
      data: [
        { id: 1, type: "Whole blood", date: "August 25, 2025", hospital: "Saint Panteleimon Hospital", status: "Canceled", amount: "450", unit: "ml" },
      ...
      >
        <View style={styles.topStatsRow}>
          <View style={[styles.topStatBadge, { backgroundColor: "#fde3e8ff" }]}>
            ...
            <Text style={[styles.topStatValue, { color: "#f06060ff" }]}>03</Text>
          </View>
          ...
          <View style={[styles.topStatBadge, { backgroundColor: "#daffddff" }]}>
            ...
            <Text style={[styles.topStatValue, { color: "#2f5e31ff" }]}>900</Text>
          </View>
        ...
        {mockHistoryData.map((section, sectionIndex) => (
              ...
              return (
                ...
                >
                  ...
                  <View style={styles.donationResult}>
                    ...
                    <Text style={styles.volumeText}>{item.amount} {item.unit}</Text>
                  </View>
                </TouchableOpacity>
              );
            })}
        ...
        <View style={styles.nextDonationCard}>
          ...
          <Text style={styles.nextDonationDate}>
            {t("available_from") || "Available from:"} <Text style={{fontWeight: 'bold'}}>October 24, 2025</Text>
          </Text>
        </View>
